 ...
 * @author tuareg
 */
public class MarketListRenderer extends javax.swing.JPanel implements ListCellRenderer {
    ...
    private void initComponents() {
        ...
        labelNemo = new javax.swing.JLabel();
    ...
    private javax.swing.JLabel labelNemo;
    // End of variables declaration//GEN-END:variables

    @Override
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        
        MarketVo company = (MarketVo) value;

        labelName.setText(company.getName());
        labelNemo.setText(company.getNemo());
